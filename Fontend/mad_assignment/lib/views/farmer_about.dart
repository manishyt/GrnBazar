...
import 'package:mad_assignment/controllers/about/about_controller.dart';
import 'package:mad_assignment/controllers/user/account_controller.dart';
// import 'package:mad_assignment/api/about_api.dart';

// ignore: must_be_immutable
class FarmerAboutUs extends StatelessWidget {
  FarmerAboutUs({super.key});
        ...
        child: Center(
          child: ListView(
            children: [
              ...
              Container(
                width: double.infinity, // Set width based on screen width
                ...
                child: FutureBuilder(
                  future: aboutController.fetchAbout(),
                  // Replace with your future data-fetching function
                      ...
                      if (snapshot.hasError) {
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return ListTile(
                              title: Text(
                                aboutController.aboutList[index].title
                                    .toString(),
                                style: const TextStyle(
                                    fontSize: 20, fontWeight: FontWeight.bold),
                              ),
                              subtitle: Text(aboutController
              ...
              Padding(
                ...
                child: Container(
                  alignment: Alignment.center,
                  decoration: BoxDecoration(
                    color: const Color.fromARGB(255, 72, 78, 241),
